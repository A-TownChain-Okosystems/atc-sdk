...
> Developer Platform - jede Anwendung (dApps, Explorer, GameFi, Marketplace, AI) spricht ueber das SDK mit der Chain, nie direkt mit dem Core.
...
Blockchain
  |
  +-- Core / RPC / P2P / Consensus
  |
  +-- ATC SDK
         +-- rust/ + typescript/ + python/ + cli/
         +-- rpc/ - crypto/ - transaction/ - wallet/
         +-- contracts/ - events/
         +-- examples/ - docs/
```
